...
PREINSTALLED = {
    ...
    "platform", "struct", "signal", "socket", "stat", "pwd", "grp",
    "threading", "multiprocessing", "concurrent", "asyncio",
    "http", "urllib", "html", "xml", "email",
    "sqlite3", "dbm", "shelve",
    "ctypes", "array", "queue", "heapq", "bisect",
    "abc", "numbers", "decimal", "fractions",
    "operator", "inspect", "dis", "ast",
    "warnings", "errno", "select", "selectors",
    "mmap", "resource", "pty", "fcntl", "termios",
    "secrets", "hmac", "token", "tokenize",
    "configparser", "tomllib", "netrc",
    "zipfile", "tarfile", "gzip", "bz2", "lzma", "zlib",
    "pickle", "marshal", "codecs",
    "getpass", "gettext", "locale",
